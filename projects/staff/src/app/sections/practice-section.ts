...
/**
 * The practice's own details: the name, contact details and registration it
 * trades under.
 *
 * IT IS A PLACEHOLDER, AND T-65 FILLS IT. What T-97 owns is the route and the
 ...
 * files now so that T-65 can fill this one without touching the other three,
